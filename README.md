...
platformlint is a PHP project for platform engineering. It focuses on this technical goal: Lint service dependency and environment fixtures for deployability risks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 157, risk penalty 5, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
