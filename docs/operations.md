...
`platformlint` is centered on platform engineering work in PHP. The technical target is: Lint service dependency and environment fixtures for deployability risks.
...
The score is deterministic. The current threshold is 157. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 6.
