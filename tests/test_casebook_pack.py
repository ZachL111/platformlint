"""Regression checks for the platformlint casebook."""
...
from casebook.harness import assert_expected, platformlint_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(platformlint_summary(), assert_expected())
